    ...
    if($id == ""){
      ...
      while($row = mysqli_fetch_assoc($result)){
        ...
        ?>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-6">
                <center>
                  <?php
                  // SHOW PARENTS OF THE LITTER HERE
          ...
          <center>
          <?php // SHOW THE LITTER HERE ?>
          <img src="../img/<?= $image ?>" class="litter-image border-default" />
          ...
          <center>
          <?php
          // SHOW PUPPIES OF THE LITTER HERE
            $litter = $row['id'];
            ...
            if($puppy_row['availability'] == "Available" && !$puppy_row['isSold']) {
              $puppy_availability = "<span class='text-success'>Available!</span>";
